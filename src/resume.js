    ...
    return (
        <section className="projects">
            ...
            <ul>
                ...
                <li><b><a href="https://user-verficiation-page-khussien.netlify.app/" target="_blank" rel="noreferrer">User Verification page</a></b> (HTML, CSS, JavaScript): 
                    Created a website that simulates a payment processing page and uses HTML and JavaScript to validate user input.</li>
            </ul>
        </section>
    );
}
